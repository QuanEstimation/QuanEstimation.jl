...
``` jl
QuanEstimation.SpinSqueezing(rho; basis="Dicke", output="KU")
```
...
**Example 4.1**  
In this example, a spin coherent state is generated.
``` jl
...
``` jl
QuanEstimation.TargetTime(f, tspan, func, args...; kwargs...)
```
