...
function error_control(scheme::Scheme; output_error_scaling=1e-6, input_error_scaling=1e-8, eps_scaling=1e-6, max_episode=1000)
    error_control_param(scheme, output_error_scaling=output_error_scaling, input_error_scaling=input_error_scaling, max_episode=max_episode)
