...
- `seed`: Random seed.
"""
ControlOpt(;ctrl=nothing, ctrl_bound=[-Inf, Inf], seed=1234) = ControlOpt(ctrl, ctrl_bound, MersenneTwister(seed))
...
Mopt_LinearComb(;B=nothing, POVM_basis=nothing, M_num=1, seed=1234) = Mopt_LinearComb(B, POVM_basis, M_num, MersenneTwister(seed))
...
Mopt_Rotation(;s=nothing, POVM_basis=nothing, Lambda=nothing, seed=1234) = Mopt_Rotation(s, POVM_basis, Lambda, MersenneTwister(seed))
...
StateControlOpt(;psi=nothing, ctrl=nothing, ctrl_bound=[-Inf, Inf], seed=1234) = StateControlOpt(psi, ctrl, ctrl_bound, MersenneTwister(seed))
...
ControlMeasurementOpt(;ctrl=nothing, M=nothing, ctrl_bound=[-Inf, Inf], seed=1234) = ControlMeasurementOpt(ctrl, M, ctrl_bound, MersenneTwister(seed))
...
StateMeasurementOpt(;psi=nothing, M=nothing, seed=1234) = StateMeasurementOpt(psi, M, MersenneTwister(seed))
"""
...
StateControlMeasurementOpt(;psi=nothing, ctrl=nothing, M=nothing, ctrl_bound=[-Inf, Inf], seed=1234) = StateControlMeasurementOpt(psi, ctrl, M, ctrl_bound, MersenneTwister(seed))
