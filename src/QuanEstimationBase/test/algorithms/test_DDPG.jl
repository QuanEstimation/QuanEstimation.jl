...
function test_ControlEnv()
	...
	env = ControlEnv(obj, dynamics, output, action_space, state_space, state, dstate, done, rng, reward, total_reward, t, tspan, tnum, ctrl_length, ctrl_num, para_num, f_noctrl, f_final, ctrl_list, ctrl_bound, total_reward_all, episode)
...
function test_StateEnv()
	...
	env = StateEnv(obj, dynamics, output, action_space, state_space, state, done, rng, reward, total_reward, ctrl_num, para_num, f_ini, f_list, reward_all, episode)
