...
PSO(max_episode, c0, c1, c2, seed::Number) =
    PSO(max_episode, c0, c1, c2, MersenneTwister(seed))
...
DE(max_episode, popsize, c, cr, seed::Number) =
    DE(max_episode, popsize, c, cr, MersenneTwister(seed))
...
NM(max_episode, state_num, ar, ae, ac, as0) =
    NM(max_episode, state_num, ar, ae, ac, as0, GLOBAL_RNG)
NM(max_episode, state_num, ar, ae, ac, as0, seed:Number) =
    NM(max_episode, state_num, ar, ae, ac, as0, MersenneTwister(seed))
