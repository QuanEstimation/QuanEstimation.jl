...
MeasurementOpt{LinearComb}(measurement,povm,M_num) = Mopt_LinearComb(measurement,povm,M_num)
...
result(opt::StateControlMeasurementOpt) =  [opt.ψ₀,opt.control_coefficients,opt.measurement,]
